...
<head>
    ...
    <style>
        /* --- CSS untuk Modal dan Tombol Aksi --- */
        /* Modal Base */
...
<body>
    ...
    <div id="detailModal" class="custom-modal">
        <div class="custom-modal-content detail-modal-content">
            ...
            <div id="detailModalBody" class="detail-grid"><!-- Konten detail akan di-load di sini --></div>
        </div>
    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        closeButtons.forEach(btn => {
            btn.onclick = () => btn.closest('.custom-modal').style.display = 'none';
        });
        ...
        confirmDeleteBtn.onclick = () => {
            if (orderIdToDelete) executeDelete(orderIdToDelete);
        };
