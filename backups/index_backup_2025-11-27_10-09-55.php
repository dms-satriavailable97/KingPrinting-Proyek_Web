    ...
    <section class="hero" id="home">
        <div class="container">
            <div class="hero-content">
                <!-- PERBAIKAN: Pisahkan hero title menjadi 2 bagian yang jelas -->
                <h1>
                    <span class="hero-main-title" data-hero-part="main">Raja di Dunia 111</span>
                    <span class="hero-highlight-title highlightsatu" data-hero-part="highlight">Promosi & Advertising</span>
                </h1>
                <p class="hero-subtitle">Spanduk, banner, stiker, baliho, brosur, dan berbagai kebutuhan cetak lainnya dengan kualitas kerajaan dan harga terjangkau.</p>
