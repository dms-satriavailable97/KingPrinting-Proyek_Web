...
<body>
    ...
    <section class="hero" id="home" style="background-color: #1a237e !important; background-color: #ff6b6b !important; background-color: #808000 !important;">
        <div class="container">
    ...
    <div class="container">
        ...
        <div class="produk-grid">
            <div class="produk-item" style="background-color: #6a1b9a !important;">
    ...
    <section class="keunggulan" style="background-color: #00796b !important;">
        <div class="container">
            <h2 class="section-title">Mengapa Memilih <span class="highlight">King Advertising</span>?</h2>
            <div class="keunggulan-grid" style="background-color: #00796b !important;">
                <div class="keunggulan-item" style="background-color: #00796b !important;">
                    <div class="keunggulan-icon" style="background-color: #00796b !important;"><i class="fas fa-crown"></i></div>
                    <h3>Kualitas Terbaik</h3><p>Hasil cetak dengan kualitas terbaik.</p>
                </div>
                <div class="keunggulan-item" style="background-color: #00796b !important;">
                    <div class="keunggulan-icon" style="background-color: #00796b !important;"><i class="fas fa-bolt"></i></div>
                    <h3>Proses Cepat</h3><p>Pengerjaan cepat tanpa mengorbankan kualitas.</p>
                </div>
                <div class="keunggulan-item" style="background-color: #00796b !important;">
                    <div class="keunggulan-icon" style="background-color: #00796b !important;"><i class="fas fa-tags"></i></div>
                    <h3>Harga Terjangkau</h3><p>Harga kompetitif dengan kualitas yang tidak mengecewakan.</p>
                </div>
                <div class="keunggulan-item" style="background-color: #00796b !important;">
                    <div class="keunggulan-icon" style="background-color: #00796b !important;"><i class="fas fa-headset"></i></div>
