...
<body>
        ...
        <div class="container">
            <div class="hero-content">
                ...
                <div class="hero-buttons">
                    ...
                    <a href="#kontak" class="btn-primary">Kontak KAMIIII</a>
                </div>
            </div>
    ...
    <div class="container">
        <h2 class="section-title">Layanan <span class="highlight">QQUUUE</span></h2>
        <div class="produk-grid">
            <div class="produk-item">
                ...
                <button class="btn-order" data-produk="Spanduk & Banner">PECANN</button>
            ...
            <div class="produk-item">
                ...
                <h3>Stiker & Label</h3>
                <p>StikAPAKma dan finishing.</p>
                <button class="btn-order" data-produk="Stiker & Label">PECANN</button>
            ...
            <div class="produk-item">
                ...
                <button class="btn-order" data-produk="Baliho & Billboard">PECANN</button>
            ...
            <div class="produk-item">
                ...
                <button class="btn-order" data-produk="Brosur & Flyer">PECANN</button>
            ...
            <div class="produk-item">
                ...
                <button class="btn-order" data-produk="Kemasan & Dus">PECANN</button>
            ...
            <div class="produk-item">
                ...
                <h3>Produk Custom</h3>
                <p>QQUUUE juga menerima pesanan produk cetak custom sesuai kebutuhan khusus Anda.</p>
                <button class="btn-order" data-produk="Produk Custom">PECANN</button>
        ...
        <div class="container">
            ...
            <div class="steps">
                <div class="step">
                    ...
                    <h3>Pilih Produk</h3>
                    <p>Pilih produk dan klik tombol "PECANN" untuk membuka form pemesanan.</p>
                </div>
                <div class="step">
            ...
            <div class="faq-wrapper">
                ...
                <div class="faq-list">
                    ...
                    <div class="faq-item">
                        ...
                        <div class="faq-answer">
                            <p>Tentu saja! QQUUUE memiliki tim desainer profesional yang siap membantu. Silakan lampirkan detail, teks, atau sketsa kasar ide Anda pada kolom catatan saat memesan.</p>
                        </div>
                    </div>
    ...
    <div class="modal" id="orderModal">
        <div class="modal-content">
            ...
            <div class="modal-header"><h2>PECANN</h2></div>
            <form id="orderForm">
