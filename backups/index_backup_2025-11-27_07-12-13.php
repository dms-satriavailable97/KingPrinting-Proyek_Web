...
<body>
    ...
    <section class="hero" id="home">
        <div class="container">
            <div class="hero-content">
                <!-- TAMBAHKAN CLASS KHUSUS UNTUK EDITOR -->
                <h1 class="editable-hero-title">Raja di Dunia <span class="highlightsatu editable-hero-highlight">Promosi & Advertising</span></h1>
                <p class="editable-hero-subtitle">Spanduk, banner, stiker, baliho, brosur, dan berbagai kebutuhan cetak lainnya dengan kualitas kerajaan dan harga terjangkau.</p>
                <div class="hero-buttons">
                    <a href="#produk" class="btn-primary">Lihat Produk</a>
                    <a href="#kontak" class="btn-primary">Kontak 12345</a>
                </div>
            </div>
    ...
    <div class="container">
        <h2 class="section-title">Layanan <span class="highlight">12345</span></h2>
        <div class="produk-grid">
            ...
            <div class="produk-item">
                ...
                <h3>Produk Custom</h3>
                <p>12345 juga menerima pesanan produk cetak custom sesuai kebutuhan khusus Anda.</p>
            ...
            <div class="faq-wrapper">
                ...
                <div class="faq-list">
                    ...
                    <div class="faq-item">
                        ...
                        <div class="faq-answer">
                            <p>Tentu saja! 12345 memiliki tim desainer profesional yang siap membantu. Silakan lampirkan detail, teks, atau sketsa kasar ide Anda pada kolom catatan saat memesan.</p>
                        </div>
                    </div>
