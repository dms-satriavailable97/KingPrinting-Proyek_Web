...
<body>
    ...
    <section class="hero" id="home" style="background-color: #1a237e !important; background-color: #ff6b6b !important; background-color: #808000 !important; background-color: #0000ff !important; background-color: #00ff00 !important;">
        <div class="container">
    ...
    <div class="container">
        ...
        <div class="produk-grid">
            <div class="produk-item" style="background-color: #6a1b9a !important; background-color: #80334c !important; background-color: #ffffff !important; border-color: #000080 !important;">
    ...
    <section class="cara-kerja" id="cara-kerja">
        <div class="container">
            ...
            <div class="steps" style="background-color: #ff9800 !important; background-color: #ffffff !important;">
                <div class="step" style="background-color: #ff9800 !important; background-color: #ffffff !important;">
                    <div class="step-number" style="background-color: #ff9800 !important; background-color: #ffffff !important;">1</div>
                    <div class="step-icon" style="background-color: #ff9800 !important; background-color: #ffffff !important;"><i class="fas fa-mouse-pointer"></i></div>
                    <h3>Pilih Produk</h3>
                    <p>Pilih produk dan klik tombol "Pesan Sekarang" untuk membuka form pemesanan.</p>
                </div>
                <div class="step" style="background-color: #ff9800 !important; background-color: #ffffff !important;">
                    <div class="step-number" style="background-color: #ff9800 !important; background-color: #ffffff !important;">2</div>
                    <div class="step-icon" style="background-color: #ff9800 !important; background-color: #ffffff !important;"><i class="fas fa-hdd"></i></div>
                    <h3>UNMUL KECE</h3>
                    <p>Lengkapi detail pesanan Anda pada form yang muncul, seperti ukuran, bahan, dan jumlah.</p>
                </div>
                <div class="step" style="background-color: #ff9800 !important; background-color: #ffffff !important;">
                    <div class="step-number" style="background-color: #ff9800 !important; background-color: #ffffff !important;">3</div>
                    <div class="step-icon" style="background-color: #ff9800 !important; background-color: #ffffff !important;"><i class="fab fa-whatsapp"></i></div>
                    <h3>Kirim ke WhatsApp</h3>
                    <p>Klik tombol kirim dan data pesanan Anda akan kami terima di sistem dan juga WhatsApp.</p>
                </div>
                <div class="step" style="background-color: #ff9800 !important; background-color: #ffffff !important;">
                    <div class="step-number" style="background-color: #ff9800 !important; background-color: #ffffff !important;">4</div>
                    <div class="step-icon" style="background-color: #ff9800 !important; background-color: #ffffff !important;"><i class="fas fa-shipping-fast"></i></div>
                    <h3>Produk Siap</h3>
    ...
    <section class="keunggulan" style="background-color: #00796b !important; background-color: #808000 !important;">
        <div class="container">
            ...
            <div class="keunggulan-grid" style="background-color: #00796b !important; background-color: #808000 !important;">
                <div class="keunggulan-item" style="background-color: #00796b !important; background-color: #808000 !important; background-color: #d84315 !important; background-color: #ffffff !important; background-color: #00796b !important; background-color: #9a2020 !important; background-color: #1e88e5 !important;">
