    ...
    <section class="hero" id="home">
        <div class="container">
            ...
            <!-- TAMBAHKAN CLASS KHUSUS UNTUK EDITOR -->
                ...
                <p class="editable-hero-subtitle">Spanduk, banner, stiker, baliho, brosur, dan berbagai kebutuhan cetak lainnya dengan kualitas kerajaan dan harga terjangkau. 1111</p>
        ...
        <div class="container">
            ...
            <div class="steps">
                ...
                <div class="step">
                    ...
                    <h3>Produk Siap</h3>
                    <p>Produk selesai dibuat, Anda dihubungi untuk proses pengambilan atau pengiriman. 111</p>
                </div>
            </div>
        </div>
    </section>
